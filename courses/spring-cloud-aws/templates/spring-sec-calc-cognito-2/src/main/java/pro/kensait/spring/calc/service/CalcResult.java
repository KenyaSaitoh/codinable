...
public class CalcResult {
    ...
    // コンストラクタ
    public CalcResult(Integer id, String username, BigDecimal param1, BigDecimal param2,
            CalcType calcType, BigDecimal result, LocalDateTime dateTime) {
        this.id = id;
    ...
    // コンストラクタ
    public CalcResult(String username, BigDecimal param1, BigDecimal param2,
            CalcType calcType, BigDecimal result, LocalDateTime dateTime) {
        this.username = username;
        this.param1 = param1;
        this.param2 = param2;
    ...
    public String toString() {
        return "CalcResult [id=" + id + ", usrename=" + username + ", param1=" + param1
                + ", param2=" + param2 + ", calcType=" + calcType + ", result=" + result
                + ", dateTime=" + dateTime + "]";
    }
}
