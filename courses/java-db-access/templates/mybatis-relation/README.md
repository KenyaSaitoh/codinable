# mybatis-relation — 結合結果のflat・join・nestマッピング

講座リポジトリ learn_java_db_aidd の `projects/master/08_mybatis-dynamic/mybatis-relation` を、Codinable で単独で動くようにしたものです。
`learn_java_db_access/mybatis_relation` から取り込んだ教材です。元のパッケージ・クラス名・例の流れを維持し、HSQLDB とビルドに合わせてあります。
...
- `pro.kensait.mybatis.company.main.FlatSelectMain1`
- `pro.kensait.mybatis.company.main.FlatSelectMain2`
- `pro.kensait.mybatis.company.main.JoinSelectMain1`
- `pro.kensait.mybatis.company.main.JoinSelectMain2`
- `pro.kensait.mybatis.company.main.NestSelectMain1`
- `pro.kensait.mybatis.company.main.NestSelectMain2`
- `pro.kensait.mybatis.company.main.InsertMain`
- `pro.kensait.mybatis.company.main.UpdateMain`
