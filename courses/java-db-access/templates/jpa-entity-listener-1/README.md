# jpa-entity-listener-1 — エンティティのライフサイクルコールバック

講座リポジトリ learn_java_db_aidd の `projects/master/06_jpa-relations/jpa-entity-listener-1` を、Codinable で単独で動くようにしたものです。
`learn_java_db_access/jpa_entity_listener_1` から取り込んだ教材です。元のパッケージ・クラス名・例の流れを維持し、HSQLDB とビルドに合わせてあります。
...
- `pro.kensait.jpa.company.main.ListernerSelectMain`
- `pro.kensait.jpa.company.main.ListernerInsertMain`
- `pro.kensait.jpa.company.main.ListernerUpdateMain`
- `pro.kensait.jpa.company.main.ListernerDeleteMain`
