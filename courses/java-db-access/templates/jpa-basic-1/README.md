# jpa-basic-1 — EntityManagerによる基本CRUDと変更検知

講座リポジトリ learn_java_db_aidd の `projects/master/05_jpa-crud/jpa-basic-1` を、Codinable で単独で動くようにしたものです。
`learn_java_db_access/jpa_basic_1` から取り込んだ教材です。元のパッケージ・クラス名・例の流れを維持し、HSQLDB とビルドに合わせてあります。
...
- `pro.kensait.jpa.company.main.SelectMain`
- `pro.kensait.jpa.company.main.InsertMain`
- `pro.kensait.jpa.company.main.UpdateMain`
- `pro.kensait.jpa.company.main.DeleteMain`
