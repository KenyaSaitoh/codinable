# mybatis-basic-2 — 型のマッピング・foreach・自動採番

講座リポジトリ learn_java_db_aidd の `projects/master/07_mybatis-crud/mybatis-basic-2` を、Codinable で単独で動くようにしたものです。
`learn_java_db_access/mybatis_basic_2` から取り込んだ教材です。元のパッケージ・クラス名・例の流れを維持し、HSQLDB とビルドに合わせてあります。
...
- `pro.kensait.mybatis.company.main.SelectMain1`
- `pro.kensait.mybatis.company.main.SelectMain2`
- `pro.kensait.mybatis.company.main.InsertMain1`
- `pro.kensait.mybatis.company.main.InsertMain2`
