# jpa-id-class-2 — IdClassと分社・社員の関連

講座リポジトリ learn_java_db_aidd の `projects/master/06_jpa-relations/jpa-id-class-2` を、Codinable で単独で動くようにしたものです。
`learn_java_db_access/jpa_id_class_2` から取り込んだ教材です。元のパッケージ・クラス名・例の流れを維持し、HSQLDB とビルドに合わせてあります。
...
- `pro.kensait.jpa.company.main.IdClassSelectMain`
- `pro.kensait.jpa.company.main.IdClassInsertMain`
- `pro.kensait.jpa.company.main.IdClassUpdateMain`
- `pro.kensait.jpa.company.main.IdClassDeleteMain`
